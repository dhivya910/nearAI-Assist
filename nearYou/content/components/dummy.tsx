...
const ChatComponent = ({ data: txHash }: { data: string }) => {
  ...
  // function setIsChatVisible(arg0: boolean): void {
  ...
  return (
    <div className="max-w-sm mx-auto mt-10 flex flex-col h-[600px] shadow-lg rounded-lg bg-black text-white">
      ...
      {/* Message Container */}
      <div className="flex-1 overflow-y-auto p-4 bg-gray-900 border border-white">
      ...
      {/* Input Field */}
      {/* <div className="bg-black p-4 border-t border-transparent rounded-b-lg"> */}
      <div className="bg-teal-900 border border-white p-4 rounded-b-lg">
        <div className="flex items-center">
          <input
            ...
            style={{
              animation: input
                ? "typing 2s steps(22, end), blink-caret 0.5s step-end infinite"
                : "",
            }}
          />
          <button
